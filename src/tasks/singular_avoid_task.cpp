...
SingularAvoidTask::SingularAvoidTask(std::string name, std::string frame_name,
...
Eigen::VectorXd SingularAvoidTask::compute_error(Configuration &config,
                                                 float dt) {
...
Eigen::MatrixXd SingularAvoidTask::compute_jacobian(Configuration &config,
                                                    float dt) {
